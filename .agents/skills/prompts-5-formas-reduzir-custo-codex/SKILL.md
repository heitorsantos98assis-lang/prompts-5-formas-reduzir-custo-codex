---
name: prompts-5-formas-reduzir-custo-codex
description: "Selecionar e aplicar os prompts migrados de prompts-5-formas-reduzir-custo-claude-code quando o usuário pedir um fluxo coberto por esta coleção. Não usar como substituto de uma skill mais específica já disponível."
---
...
- `00-leia-primeiro.md` — 00 — Leia primeiro
- `01-copywriting.md` — 01 — Copywriting
- `02-automacao.md` — 02 — Automacao
- `03-analise-de-dados.md` — 03 — Analise de Dados
- `04-atendimento.md` — 04 — Atendimento
- `05-documentos.md` — 05 — Documentos
- `calculadora-roi.md` — Calculadora de ROI — vale migrar?
- `checklist-migracao.md` — Checklist de Migracao — 12 passos
